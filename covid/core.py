...
__all__ = ['setDefaults', 'ROOT', 'CONFIRMED', 'DEATHS', 'RECOVERED', 'getToday', 'getYesterday',
           'getDayBeforeYesterday', 'procDataframe', 'procUrl', 'getCountriesDailyReport', 'plotCountriesDailyReport',
           'plotCountryDailyReport', 'getTimeSeriesConfirmed', 'getTimeSeriesDeaths', 'getTimeSeriesRecovered',
           'procTimeSeriesDataframe', 'procTimeSeries', 'procTimeSeriesDeaths', 'procTimeSeriesConfirmed',
           'plotCountriesTimeSeries', 'getCountriesDailyReportFromAPI', 'plotCountriesDailyReportFromAPI',
           'getCategoryByCountryFromAPI', 'plotCategoryByCountryFromAPI']
...
def plotCountriesDailyReport(df: pd.DataFrame, which: str, topN: int=10, color: str='y', kind: str='Confirmed', visualisation: str='matplotlib') -> None:
    if df.empty == True:
        print(f'Empty data frame - are you sure the file/url exists?')
        return df
...
def plotCountryDailyReport(df: pd.DataFrame, country: str, which: str, topN: int=10, color: str='orange', kind: str='Confirmed', visualisation: str='matplotlib') -> None:
    if df.empty == True:
        print(f'Empty data frame - are you sure the file/url exists?')
        return df
    if visualisation == 'altair':
...
def plotCountriesDailyReportFromAPI(normalised=False, visualisation='matplotlib', cutoff=10, transformFold=True) -> None:
